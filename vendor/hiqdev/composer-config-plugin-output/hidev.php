...
return array (
  ...
  array (
    ...
    'include' => 
    array (
      0 => $baseDir . '/vendor/codexten/app-admin-dev/config/goals.yml',
      1 => $baseDir . '/vendor/codexten/yii-app-console/src/config/goals.yml',
      2 => $baseDir . '/vendor/codexten/yii-app-storage/src/hidev/goals.yml',
      3 => $baseDir . '/vendor/codexten/yii-dev/src/config/goals.yml',
    ),
    'adminApp' => 
    array (
      'class' => 'hidev\\components\\Directory',
    ),
    'view' => 
    array (
      'theme' => 
      array (
        ...
        array (
          '@hidev/views' => 
          array (
            0 => '@codexten/admin/dev/views',
            1 => '@codexten/yii/console/views',
            2 => '@codexten/yii/storage/hidev/views',
            3 => '@hidev/nginx/views',
            4 => '@yii/views',
          ),
        ),
    ...
    'consoleApp' => 
    array (
      'class' => 'codexten\\yii\\console\\components\\ConsoleApp',
    ),
    'storageApp' => 
    array (
      'class' => 'hidev\\components\\Directory',
    ...
    array (
      ...
      'etcDir' => $baseDir . '/docker/nginx/sites-available',
    ),
    'hosts' => 
    array (
    ...
    'ext' => 
    array (
      'class' => 'codexten\\yii\\dev\\components\\Ext',
    ),
    'en' => 
    array (
      'class' => 'codexten\\yii\\dev\\components\\En',
    ),
  ),
  'container' => 
  array (
    ...
    array (
      ...
      'hidev\\base\\File' => 
      array (
        'class' => 'codexten\\yii\\dev\\base\\File',
      ),
      'hidev\\components\\File' => 
      array (
        'class' => 'codexten\\yii\\dev\\components\\File',
      ),
    ),
  ),
  'controllerMap' => 
  array (
    'admin-app' => 
    array (
      'class' => 'codexten\\admin\\dev\\console\\AdminAppController',
    ),
    'console-app' => 
    array (
      'class' => 'codexten\\yii\\console\\controllers\\ConsoleAppController',
    ),
    'storage-app' => 
    array (
      'class' => 'codexten\\yii\\storage\\hidev\\controllers\\StorageAppController',
    ),
    'gii' => 
    array (
      'class' => 'codexten\\yii\\gii\\console\\GiiController',
      'defaultParams' => 
      array (
        'enableI18N' => true,
        'overwrite' => false,
      ...
      'defaultCrudParams' => 
      array (
        'baseControllerClass' => 'codexten\\yii\\web\\CrudController',
      ),
    ),
    'nginx' => 
    array (
    ...
    'ext' => 
    array (
      'class' => 'codexten\\yii\\dev\\console\\ExtController',
    ),
  ),
  'modules' => 
  array (
    ...
    array (
      ...
      array (
        'model' => 
        array (
          'class' => 'codexten\\yii\\gii\\generators\\model\\ModelGenerator',
          'templates' => 
          array (
        ...
        'crud' => 
        array (
          'class' => 'codexten\\yii\\gii\\generators\\crud\\CrudGenerator',
          'templates' => 
          array (
        ...
        'package' => 
        array (
          'class' => 'codexten\\yii\\gii\\generators\\package\\PackageGenerator',
          'templates' => 
          array (
