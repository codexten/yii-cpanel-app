...
return array (
  ...
  array (
    ...
    array (
      ...
      'initFile' => 'empty-db.sql',
      'initFileWithData' => 'init-db.sql',
      'repo' => '',
    ),
    'message' => 
    array (
      'class' => 'codexten\\yii\\console\\controllers\\MessageController',
    ),
    'cron' => 
    array (
      'class' => 'codexten\\yii\\cron\\commands\\CronController',
    ),
    'seed' => 
    array (
      'class' => 'codexten\\yii\\console\\controllers\\SeedController',
    ),
    'git' => 
    array (
      'class' => 'codexten\\yii\\console\\controllers\\GitController',
    ),
    'mailqueue' => 
    array (
      'class' => 'codexten\\yii\\mailqueue\\commands\\MailQueueController',
    ),
    'instance' => 'console\\controllers\\InstanceController',
  ),
