...
return array (
  ...
  array (
    ...
    1 => 'codexten\\yii\\modules\\auth\\components\\SiteHelper',
  ),
  'viewPath' => '@app/views',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          '@app/views' => 
          array (
            0 => '@codexten/yii/web/views',
            1 => '@codexten/yii/admin/views',
            2 => '@codexten/yii/bootstrap3/views',
            3 => '@codexten/yii/adminlte2/views',
            4 => '@admin/views',
          ),
          '@app/widgets/views' => 
          array (
            0 => '@codexten/yii/web/widgets/views',
            1 => '@codexten/yii/bootstrap3/widgets/views',
            2 => '@codexten/yii/adminlte2/widgets/views',
          ),
          '@app/widgets/grid' => 
          array (
            0 => '@codexten/yii/web/widgets/grid',
          ),
          '@codexten/yii/modules/auth/' => 
          array (
            0 => '@codexten/yii/adminlte2/modules/auth/',
          ),
        ),
      ),
    ),
    'user' => 
    array (
      'class' => 'codexten\\yii\\web\\User',
      'identityClass' => 'codexten\\yii\\modules\\auth\\models\\User',
      'loginUrl' => 
      array (
        0 => '/auth/account/login',
      ),
      'logoutUrl' => 
      array (
        0 => '/auth/account/logout',
      ),
      'registerUrl' => 
      array (
        0 => '/auth/registration/register',
      ),
    ),
    'themeManager' => 
    array (
      'class' => 'codexten\\yii\\web\\ThemeManager',
      'defaultTheme' => 'adminLte2',
      'themes' => 
      array (
        'adminLte2' => 
        array (
          'class' => 'codexten\\yii\\web\\Theme',
          'assets' => 
          array (
            0 => 'dmstr\\web\\AdminLteAsset',
          ),
        ),
      ),
    ),
    ...
    'userSettings' => 
    array (
      'class' => 'codexten\\yii\\user\\settings\\components\\UserSettings',
    ),
    'adminSettings' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'yii\\web\\UrlManager' => 
      array (
        'class' => 'codexten\\yii\\web\\UrlManager',
      ),
      'yii\\web\\User' => 
      array (
        'class' => 'codexten\\yii\\web\\User',
      ...
      'codexten\\yii\\modules\\auth\\actions\\AccountLoginAction' => 
      array (
        'modelClass' => 'codexten\\yii\\modules\\auth\\models\\LoginForm',
        'layout' => '/base',
      ),
      'codexten\\yii\\modules\\auth\\actions\\RegistrationRegisterAction' => 
      array (
        'modelClass' => 'codexten\\yii\\modules\\auth\\models\\RegistrationForm',
        'layout' => '/base',
      ),
      'codexten\\yii\\web\\widgets\\Page' => 
      array (
        'class' => 'codexten\\yii\\web\\widgets\\Page',
      ...
      'dmstr\\widgets\\Menu' => 
      array (
        'class' => 'codexten\\yii\\adminlte2\\widgets\\Menu',
      ),
    ),
  ),
  ...
  array (
    'site' => 
    array (
      'class' => 'codexten\\yii\\web\\controllers\\SiteController',
    ),
    'dashboard' => 
    array (
      'class' => 'admin\\controllers\\DashboardController',
    ),
    'sign-in' => 
    array (
  ...
  array (
    ...
    'auth' => 
    array (
      'class' => 'codexten\\yii\\modules\\auth\\AuthModule',
      ...
      array (
        'registration' => 
        array (
          'class' => 'codexten\\yii\\modules\\auth\\controllers\\RegistrationController',
        ),
        'account' => 
        array (
          'class' => 'codexten\\yii\\modules\\auth\\controllers\\AccountController',
          'viewPath' => '@codexten/yii/module/auth/views',
        ),
        'phone-number-verification' => 
        array (
          'class' => 'codexten\\yii\\modules\\auth\\controllers\\PhoneNumberVerificationController',
        ),
        'email-verification' => 
        array (
          'class' => 'codexten\\yii\\modules\\auth\\controllers\\EmailVerificationController',
        ),
      ),
    ...
    'cron' => 
    array (
      'class' => 'codexten\\yii\\cron\\CronModule',
    ),
    'process' => 
    array (
      'class' => 'codexten\\yii\\process\\ProcessModule',
    ),
    'debug' => 
    array (
